...
(
    ...
    for ARCH in "${ARCHES[@]}"; do
        ...
        echo -e "\033[1;38;5;${COLOR}m>>>\033[0m \033[1;38;5;${COLOR}m gstreamer-selkies_gpl_${GIT_TAG#v}_debian13_$ARCH.tar.gz\033[0m"
        ...
        docker buildx build \
            ...
            --build-arg=DISTRIB_RELEASE="${BASE_IMAGE//*:/}" \
            "${TAG_ARGS[@]}" \
            -f Dockerfile.debian \
            --load .
    done
...
(set -x; docker run --rm -i -v ./dist:/dist "$I" \
